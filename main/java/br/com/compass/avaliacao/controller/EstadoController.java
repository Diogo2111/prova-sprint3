...
import br.com.compass.avaliacao.controller.dto.EstadoDto;
import br.com.compass.avaliacao.controller.form.AtualizaEstadoForm;
import br.com.compass.avaliacao.controller.form.EstadoForm;
...
public class EstadoController {
	...
	@GetMapping
	public List<EstadoDto> lista(String nome, Regiao regiao, Long populacao, Long area) {
		
	

		if (nome == null && regiao == null && populacao == null && area == null) {

			List<Estado> estados = estadoRepository.findAll();
			return EstadoDto.converter(estados);

		} else if (nome == null && populacao == null && area == null) {

			List<Estado> estados = estadoRepository.findByRegiao(regiao);
			return EstadoDto.converter(estados);

		}else if (nome == null && regiao == null  && area == null) {

			List<Estado> estados = estadoRepository.findBypopulacao(populacao);
			return EstadoDto.converter(estados);

		}else if (nome == null && regiao == null && populacao == null) {

			List<Estado> estados = estadoRepository.findByarea(area);
			return EstadoDto.converter(estados);
